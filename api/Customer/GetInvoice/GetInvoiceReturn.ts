interface GetInvoiceReturn {
    ...
    "PageInfo": {
        ...
        // if the maximum number of rows is not available.
...
//The SalesInvoiceDespatch datatable is only available when using the Customer.GetInvoiceC service.
